...
const HomePage: React.FC = () => {
  ...
  const handleSampleImageSelect = async (imageUrl: string, imageName: string) => {
    setIsAnalyzing(true);
    setError(null);
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Upload your construction drawings or site photos and get instant
                AI recommendations for the best Doka formwork solutions.
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 my-12">
              ...
              <span className="text-gray-500 font-semibold uppercase text-sm tracking-wider">
            ...
            <div className="max-w-5xl mx-auto mb-12">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {sampleImages.map((sample) => (
                  <div
                    key={sample.id}
                    className="group relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-gray-200 hover:border-doka-yellow"
                  >
