        ...
        <div className="max-w-4xl w-full">
          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              We're crafting something extraordinary. The <span className="font-semibold text-doka-blue">Doka Analysis</span> platform 
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-doka-yellow hover:-translate-y-1">
              ...
              <h3 className="text-lg font-bold text-doka-blue mb-2">Powerful Insights</h3>
              <p className="text-gray-600 text-sm">Advanced analytics for your construction projects</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-doka-blue hover:-translate-y-1">
              ...
              <h3 className="text-lg font-bold text-doka-blue mb-2">Real-Time Data</h3>
              <p className="text-gray-600 text-sm">Monitor your projects with live updates</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-doka-yellow hover:-translate-y-1">
              ...
              <h3 className="text-lg font-bold text-doka-blue mb-2">Customizable</h3>
