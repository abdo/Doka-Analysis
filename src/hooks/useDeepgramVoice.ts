...
const talkWsUrl = import.meta.env.VITE_WS_URL;
            ...
            case 'ConversationText': {
              if (isConversationTextMessage(message)) {
                if (message.role === 'user') {
                  ...
                  setConversationHistory(prev => [...prev, { role: 'user', content: message.content }]);
                } else if (message.role === 'assistant') {
                  setAgentResponse(message.content);
                  setConversationHistory(prev => [...prev, { role: 'agent', content: message.content }]);
                }
              }
              break;
            }
